...
# ==============================================================================
# THIS VERSION RE-ADDS the liquidation detection feature to the backtesting
# engine to ensure its results match the live trading logic.
# ==============================================================================
                        ...
                        if direction and abs(entry_price - sl_price) > 0:
                            ...
                            if liquidation_price is not None:
                                if direction == "long" and sl_price <= liquidation_price: 
                                    ...
                                    app.logger.warning(f"[{symbol}] SL adjusted to avoid liquidation.")
            ...
            if current_main_idx and current_main_idx >= 50:
                ...
                if not open_position:
                    ...
                    if direction and zone:
                        ...
                        # --- FIX: ADDED LIQUIDATION GUARD TO BACKTESTER ---
                        liquidation_price = calculate_liquidation_price(entry_price, leverage, direction)
                        if liquidation_price is not None:
                        ...
                        if risk_per_unit > 0:
                            ...
                            if total_quantity > 0:
                                open_position = {
                                    ...
                                    'tp3_qty': total_quantity - (total_quantity * 0.33 * 2), 'initial_margin': (entry_price * total_quantity) / leverage if leverage > 0 else 1
                                }
